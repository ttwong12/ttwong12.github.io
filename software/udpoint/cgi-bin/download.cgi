...
print "<MEtA http-equiv='REFRESH' content='1;url=http://www.cse.cuhk.edu.hk/~ttwong/demo/udpoint/$input{'downwhat'}'>";


# Write a record to log file
$file = <./udpoint-download.csv>;
open(fh, ">>$file");
...
print fh "$mday/$mon/$year,$hour:$min:$sec,$input{'downwhat'}\n";
